...
RSpec.describe GoodJob::Scheduler do
  ...
  describe 'fiber execution', :fiber_isolation, :requires_async do
    ...
    it 'does not lower the shared reactor thread priority when lower_thread_priority is enabled' do
    ...
    it 'schedules a replacement after the completed fiber is available' do
